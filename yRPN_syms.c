...
tOPER     s_opers [MAX_OPER] = {
   ...
   { "##"  , 'g', 'r',  4, 'h',  S_LEFT , 2, S_YES, S_YES, ""  , "string concatination"                 },
   /*---(shift)------------------*/
   { "<<"  , 'B', 'r',  5, 'i',  S_LEFT , 2, S_YES, S_YES, "ª" , "bitwise shift left"                   },
   ...
   { "!&"  , 'B', 'r', 11, 'o',  S_LEFT , 2, S_YES, S_YES, "Ó" , "NAND (at least one is false)"         },
   { "||"  , 'B', 'r', 12, 'p',  S_LEFT , 2, S_YES, S_YES, "Ñ" , "logical OR"                           },
   { "!|"  , 'B', 'r', 12, 'p',  S_LEFT , 2, S_YES, S_YES, "Ô" , "NOR (neither/nor)"                    },
   { "&|"  , 'B', 'r', 12, 'p',  S_LEFT , 2, S_YES, S_YES, "Ò" , "XOR (one and only one)"               },
   /*---(conditional)------------*/
