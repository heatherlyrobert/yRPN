...
char     *v_alphanum  = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789_ËÈÍÎÏÌÓÔÒÚÛÙıˆ˜¯˘˙˚¸˝˛ˇ¿¡¬√ƒ≈";
char     *v_alpha     = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz_ËÈÍÎÏÌÓÔÒÚÛÙıˆ˜¯˘˙˚¸˝˛ˇ";
...
tOPER     s_opers [MAX_OPER] = {
   ...
   { "À"   , "À"   , 'B', 'r',  1, 'e',  S_LEFT , 2, S_YES, S_NO , S_NO , S_NO , ""  , "scientific exponent"                  },
   { "À-"  , "À-"  , 'B', 'r',  1, 'e',  S_LEFT , 2, S_YES, S_NO , S_NO , S_NO , ""  , "scientific exponent"                  },
   { "À+"  , "À+"  , 'B', 'r',  1, 'e',  S_LEFT , 2, S_YES, S_NO , S_NO , S_NO , ""  , "scientific exponent"                  },
   { "∆"   , "∆"   , 'B', 'r',  1, 'e',  S_LEFT , 1, S_NO , S_YES, S_NO , S_YES, ""  , "power of two, squared"                },
   { "«"   , "«"   , 'B', 'r',  1, 'e',  S_LEFT , 1, S_NO , S_YES, S_NO , S_YES, ""  , "power of three, cubed"                },
   { "»"   , "»"   , 'B', 'r',  1, 'e',  S_LEFT , 1, S_NO , S_YES, S_NO , S_YES, ""  , "power of four"                        },
   { "…"   , "…"   , 'B', 'r',  1, 'e',  S_LEFT , 1, S_NO , S_YES, S_NO , S_YES, ""  , "power of x"                           },
   { " "   , " "   , 'B', 'r',  1, 'e',  S_LEFT , 1, S_NO , S_YES, S_NO , S_YES, ""  , "power of y"                           },
   { "Œ"   , "Œ"   , 'B', 'r',  1, 'e',  S_LEFT , 1, S_NO , S_YES, S_NO , S_YES, ""  , "power of half, square root"           },
   { "Õ"   , "Õ"   , 'B', 'r',  1, 'e',  S_LEFT , 1, S_NO , S_YES, S_NO , S_YES, ""  , "radian operator"                      },
   { "Ã"   , "Ã"   , 'B', 'r',  1, 'e',  S_LEFT , 1, S_NO , S_YES, S_NO , S_YES, ""  , "degree operator"                      },
   /*---(element of)-------------*/
   ...
   { "->"  , "->"  , 'c', 'r',  1, 'e',  S_LEFT , 2, S_YES, S_NO , S_NO , S_NO , "÷" , "element selection thru pointer"       },
   /*---(unary/prefix)-----------*/
   ...
   { "!="  , "!="  , 'B', 'r',  7, 'k',  S_LEFT , 2, S_YES, S_NO , S_YES, S_YES, "ﬁ" , "relational inequality"                },
   ...
   /*---(logical)----------------*/
   { "&&"  , "&&"  , 'B', 'r', 11, 'o',  S_LEFT , 2, S_YES, S_NO , S_YES, S_YES, "–" , "logical AND"                          },
   { "!&"  , "!&"  , 'B', 'r', 11, 'o',  S_LEFT , 2, S_YES, S_NO , S_YES, S_YES, "‘" , "NAND (at least one is false)"         },
   { "||"  , "||"  , 'B', 'r', 12, 'p',  S_LEFT , 2, S_YES, S_NO , S_YES, S_YES, "—" , "logical OR"                           },
   { "!|"  , "!|"  , 'B', 'r', 12, 'p',  S_LEFT , 2, S_YES, S_NO , S_YES, S_YES, "’" , "NOR (neither/nor)"                    },
   { "&|"  , "&|"  , 'B', 'r', 12, 'p',  S_LEFT , 2, S_YES, S_NO , S_YES, S_YES, "“" , "XOR (one and only one)"               },
   { "|&"  , "|&"  , 'B', 'r', 12, 'p',  S_LEFT , 2, S_YES, S_NO , S_YES, S_YES, "”" , "NXOR (both the same)"                 },
   /*---(conditional)------------*/
...
{  /*---(design notes)--------------------------------------------------------*/
   ...
   --rce;  if (strchr ("Èˆı" YSTR_NUMBER, myRPN.working [a_pos]) == 0) {
...
{  /*---(design notes)--------------------------------------------------------*/
   ...
   /*---(save variables)-------------------*/
      ...
      if (myRPN.t_name [0] == 'Á')              myRPN.t_type = S_TTYPE_LOCAL;
      strlcpy (myRPN.t_token, myRPN.t_name, LEN_FULL);
      yRPN_stack_tokens  ();         /* strait to tokens list                          */
      yRPN__token_save    (a_pos);
   }
